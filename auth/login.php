...
<img src="<?php echo $part;?>dist/img/logo.png" class="img-fluid" alt="Responsive image" width=200px; height=200px;>
<div class="login-box">
    <div class="login-logo">

    <a href="<?php echo $part;?>index.php" class="text-lg"><b>ฝ่าย</b>สรรพกำลัง มทบ.32</a>
      ...
      <form action="checkLogin.php" method="post" class="needs-validation" novalidate>
			<?php
				if($_GET['msg']) {
					...
					Password ไม่ถูกต้อง กรุณาลองอีกครั้ง
				</div>";
        }
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="name" id="name" placeholder="User" required>
